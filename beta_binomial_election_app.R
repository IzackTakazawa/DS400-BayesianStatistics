...
## interval.
##
## Your answer: alpha: 210, beta: 140
## Mean = 0.60
## 95% CI ~ 54.8%, 65.1%
##
##
...
##
## Your answer: Mean doesn't change stays put at 0.450
## 95% CI ~ (35.4%, 54.8%) -> (40.2%, 49.9%)
## The mean only depends on the alpha:beta ratio, which 4x scaling preserves
## the FINISH WRITING
##
##
## ------------------------------------------------------------
